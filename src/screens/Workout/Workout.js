          ...
          <ModalContent bg="gray.600">
            <div>
              <div className="flex justify-end p-2">
                <button className=" text-lg text-gray-300" onClick={onClose}>
              ...
              <div className=" my-5 flex flex-col gap-3 items-center">
                ...
                >
                  <input
                    type="text"
                    className=" bg-gray-500 w-4/5 rounded-md p-2 text-white"
                    value={search}
                    onChange={(e) => setSearch(e.target.value.toLowerCase())}
                  />
                  <button type="submit" className="py-2 px-3 text-gray-300">
                    <i class="bi bi-search"></i>
                  </button>
                </form>
              </div>
              <div className="grid grid-cols-4 gap-1 py-4 px-5">{<SearchedExercise card={exercises} />}</div>
            </div>
          </ModalContent>
        </Modal>
      </div>
