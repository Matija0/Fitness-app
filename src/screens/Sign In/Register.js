    ...
    <div  style={{maxWidth: "500px"}} className=' mx-auto my-7 rounded-xl  flex flex-col items-center bg-gray-800 py-7'>
       <div> <h1 className='text-white text-xl font-bold mb-4'>Create your free account</h1></div>
        ...
        <form className='flex flex-col space-y-4'>
            ...
            <button type='submit' className='bg-blue-700 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center'>Create an account</button>
