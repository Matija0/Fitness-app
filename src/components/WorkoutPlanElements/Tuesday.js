                    ...
                    return (
                      <Accordion defaultIndex={[1]} allowMultiple backgroundColor={"gray.800"} borderRadius={"5px"}>
                        <AccordionItem border={"none"} marginBottom={"15px"}>
                          ...
                          <AccordionPanel pb={4}>
                            <div className="flex justify-end"><button className=" border border-gray-300 text-gray-200 text-sm  py-1  rounded-lg px-3  w-fit" onClick={""}><i class="bi bi-trash3"></i></button></div>
