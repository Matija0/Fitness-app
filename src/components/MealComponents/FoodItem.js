...
const Test = (props) => {
    return (
        <div className=' bg-gray-300 rounded-lg text-gray-800 py-3 flex flex-col px-10 mb-4 items-center justify-center gap-4'>
            ...
            <button className=" text-gray-800  w-1/2  text-2xl   rounded-md mt-auto" onClick={props.addFood}><i class="bi bi-database-add"></i></button>
        </div>
    )
}
